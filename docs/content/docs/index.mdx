...
- **WordPress and PHP frameworks** — ship Tailwind-powered themes and plugins without asking users to install Node.js or run a build. Just `composer require` and go.
